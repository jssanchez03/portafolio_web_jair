  ...
  return (
    <div className="sm-scope w-full h-full">
      ...
      >
        ...
        <header className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-4 bg-transparent pointer-events-none z-20">
          {showControls && (
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-1 bg-transparent border-none cursor-pointer font-medium leading-none overflow-visible pointer-events-auto focus-visible:outline-2 focus-visible:outline-white/70 focus-visible:outline-offset-4 focus-visible:rounded ml-auto"
          ...
          >
            <span
              ref={textWrapRef}
              className="sm-text-wrap relative overflow-hidden leading-none"
            >
              <span
                ref={textInnerRef}
                className="sm-text-inner block [will-change:transform]"
              >
                {textLines.map((line, i) => (
                  <span
                    key={i}
                    className="sm-text-line block leading-none"
                    aria-hidden={i > 0}
                  >
                    {line}
                  </span>
...
@media (max-width: 640px) { 
  .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; padding: 4em 1.5em 1.5em 1.5em; } 
  .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } 
  .sm-scope .sm-prelayers { width: 100%; left: 0; right: 0; }
